...
import com.mucanze.brewer.model.validation.group.CnpjGroup;
import com.mucanze.brewer.model.validation.group.CpfGroup;
...
public enum TipoPessoa {
	...
	JURIDICA("Juridica", "CNPJ", "00.000.000/0000-00", CnpjGroup.class) {
		@Override
		public String formatar(String cpfOuCnpj) {
			return cpfOuCnpj.replaceAll("(\\d{2})(\\d{3})(\\d{4})(\\d{2})", "$1.$2.$3/$4-");
		}
	};
